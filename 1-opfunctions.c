...
void add(stack_t **stack, unsigned int line_number)
{
	...
	if (!stack || !(*stack) || !(*stack)->next)
		err(stack, "L%d: can't add, stack too short\n", line_number);
	tmp = (*stack)->next;
	tmp->n += (*stack)->n;
	*stack = tmp;
	free((*stack)->prev);
...
void sub(stack_t **stack, unsigned int line_number)
{
	...
	if (!stack || !(*stack) || !(*stack)->next)
		err(stack, "L%d: can't sub, stack too short\n", line_number);
	tmp = (*stack)->next;
	tmp->n -= (*stack)->n;
	*stack = tmp;
	free((*stack)->prev);
...
void divide(stack_t **stack, unsigned int line_number)
{
	...
	if (!stack || !(*stack) || !(*stack)->next)
		err(stack, "L%d: can't div, stack too short\n", line_number);
	if ((*stack)->n == 0)
...
void mul(stack_t **stack, unsigned int line_number)
{
	...
	if (!stack || !(*stack) || !(*stack)->next)
		err(stack, "L%d: can't mul, stack too short\n", line_number);
	tmp = (*stack)->next;
	tmp->n *= (*stack)->n;
	*stack = tmp;
	free((*stack)->prev);
